...
Examples:
  ...
  glider -listen udp://:53 -forward socks5://serverA:1080,udp://223.5.5.5:53
    -udp tunnel: listen on :53 and forward all udp requests to 223.5.5.5:53 via remote socks5 server.
  
  glider -verbose -dns=:53 -dnsserver=223.5.5.5:53 -forward socks5://serverA:1080 -dnsrecord=abc.com/1.2.3.4
    -dns over proxy: listen on :53 as dns server, forward to 223.5.5.5:53 via socks5 server.
```
